...
export const RecordsTabScreen: React.FC<RecordsTabScreenProps> = ({ navigation }) => {
  const { user } = useAuth();
  ...
  const renderSyncStatus = (isSynced: boolean) => (
    <Animated.View
      style={[
        ...
        { transform: [{ scale: isSynced ? 1 : pulseAnim }] },
      ]}
    />
  );
      ...
      <Animated.View
        ...
        <Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
          <TouchableOpacity
            ...
            <Text style={styles.primaryButtonText}>🚀 Start Collecting Data</Text>
          </TouchableOpacity>
        </Animated.View>
  ...
  return (
    <View style={styles.container}>
      ...
      <LinearGradient
        ...
        <View className="bg-gradient-to-b from-[#00963f] to-[#f7a607]" style={styles.content}>
          {/* Header */}
          <Animated.View
            style={[
              styles.header,
          ...
          <Animated.View
            ...
            <View style={styles.syncCardHeader}>
              ...
              <Animated.View
                style={{
                  transform: [{ scale: isSyncing ? pulseAnim : 1 }],
                }}>
                <LinearGradient
                  colors={
